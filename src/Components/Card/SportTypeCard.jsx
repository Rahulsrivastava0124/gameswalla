export const SportTypeCard = (props) => {
    return (
        <div className="md:card rounded-xl overflow-hidden border border-red-300  bg-base-100 shadow-xl mb-6">
            <figure className='bg-red-50 md:p-[2rem] p-[2rem] transition ease-in-out hover:scale-105'><img src={props.data.image} alt="Movie" className="w-[10rem] mix-blend-darken m-auto"/>
            </figure>
