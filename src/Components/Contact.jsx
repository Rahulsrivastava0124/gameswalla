...
export const Contact = () => {
    return (
        <div className="md:my-16 mb-8">
            <h1 className=" text-4xl md:text-4xl font-bold text-yellow-400 my-8 md:my-16  divider divider-error mx-8 md:mx-72 rounded-2xl my-4 ">Contact </h1>
            <div className="flex  border border-red-500 md:mx-16 mx-2 rounded-lg bg-red-800 text-black">
                <div className="md:px-4 px-2 md:m-8  rounded-md w-[100%]">
                    <div className="md:flex justify-center items-center hidden md:d-block">
                        ...
                        <h1 className="md:text-3xl text-2xl mb-6">
                            <span className="text-yellow-400">games</span><span className="text-white">walla</span>.in
                        </h1>
                    </div>
                    <div className="justify-center ">
                        <div className=" mb-4">
                            <h1 className="text-3xl md:mb-4 my-2 mr-2 text-white ">Contact For Support</h1>
                        ...
                        <span className="flex md:w-72 p-2 bg-red-100 border border-red-200 mb-2 mr-4 rounded-xl">
                            <PhoneIcon className="h-6 text-red-600 sm:block hidden"/>
                            <span className=" md:ml:2 md:text-3xl font-bold">+91 9650310182</span>
                        </span>
                            <span
                                className="flex md:w-72  items-center p-2 bg-red-100 border border-red-200 mb-2 w- mr-4 rounded-xl">
                            <PhoneIcon className="h-6 text-red-600 sm:block hidden"/>
                            <span className=" md:ml-2 md:text-3xl font-bold">+91 9205612043</span>
                            </span>
                            <span
                            ...
                            <span className="text-base md:ml-2 md:text-3xl font-bold">+919500981942</span>
                            </span>
                            </span>
                        </div>
                        <div className=" mb-4">
                            <h1 className="text-3xl mb-4 mr-4 text-white">Contact For New ID</h1>
                        ...
                        <span className="flex justify-center  w-[100%] md:w-72  p-2 bg-red-100 border border-red-200 mb-2 mr-4 rounded-xl">
                            <PhoneIcon className="h-6 text-red-600"/>
                            <span className="ml-2 md:text-3xl font-bold">+91 9650310182</span>
                        </span>
                            <span
                                className="flex  justify-center w-[100%] md:w-72  items-center p-2 bg-red-100 border mr-4 border-red-200 mb-2 rounded-xl">
                            <PhoneIcon className="h-6 text-red-600"/>
                            <span className="ml-2 md:text-3xl font-bold">+91 9205612043</span>
                            </span>
                            </span>
                        </div>
                    </div>
