...
import PhoneApp from '../Images/GAMES-WALAs.png'
    ...
    return (
        <div className="my-10">
            ...
            <div className='text-start md:mx-24 text-lg'>
                <p className='mb-3'>GamesWalla offers a wide variety of bonuses and promotions. These bonuses and promotions help in boosting the morale and confidence of the users. They can also help them stand a chance of winning big. They not only provide bonuses and promotions but also conduct special events often. The list keeps constantly updating. However, the welcome bonus remains constant.</p>
...
<ul className='mb-3 ml-4'>
    ...
    <li> Deposit money 1 Lac Above and get a 6% Guaranteed Bonus</li>
                   ...
                   <p> You can get a maximum of up to Rs12000 on the site. The fun does not end there. You can now refer your friends and earn money with GamesWalla.in You can get a referral bonus of up to Rs 5000.</p>

                    <p>Here is everything you need to know about the bonuses and promotions offered by GamesWalla.in You can read through it and make the most of it.</p>
            </div>
            <div>
            </div>
                    <div className='md:mx-24 text-lg text-start'>
                        ...
                        <p  className='mb-3'>The odds and margins are the most important components of sports betting both online and offline. Taking all the online betting sites in India into consideration GamesWalla offers the most competitive odds and margins of them all. This helps them attract and retain customers. The odds and margins, however, may vary depending on the popularity of the event or market. There are other factors including the bets placed, and the level of competition it faces from other sportsbooks that come into play.</p>
...
<p className='mb-6'>GamesWalla makes its presence available in the form of both a website and a mobile app. It is to reach out to more customers. Nowadays everyone is busy on their smartphones and people barely use a website on a desktop to function. The mobile app is more convenient. You can simply download it from the website and use it on your smartphone.</p>
                            <p>The mobile version of GamesWalla contains features that include placing bets, checking your wallet balance, depositing and withdrawing, watching live matches, and checking live scores. You can also receive notifications on bonuses and promotions. The app has a user-friendly interface that any user would find easier to adapt to.</p>

                        </div>
                        <div className=" md:w-[37rem] w-[30rem]">
                           <img src={PhoneApp} alt={"Phone App"} className='md:h-[30rem] h-[20rem] m-auto'/>
                        </div>
                    </div>
                    <div>
                        <h2 className="text-3xl my-8 font-medium divider  divider-error">
                        ...
                        <div className="flex flex-wrap justify-center">
                            <img src={master} alt='master card'
                                 className="w-[10rem] md:mx-4 mx-2 border px-9 rounded-lg py-4   border-red-300 shadow mb-4"/>
